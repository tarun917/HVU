...
function Hero() {
  ...
  return (
    <section className="hero-section relative flex flex-col items-center justify-center text-center bg-gradient-to-r from-gray-900 via-black to-gray-900 text-white py-60 overflow-hidden">
      {/* Background Glow */}
